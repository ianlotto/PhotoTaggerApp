...
ActiveRecord::Schema.define(:version => 20130927135647) do
  ...
  add_index "photo_taggings", ["user_id", "photo_id"], :name => "index_photo_taggings_on_user_id_and_photo_id", :unique => true
